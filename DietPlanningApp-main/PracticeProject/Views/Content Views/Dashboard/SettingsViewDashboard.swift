...
struct SettingsViewDashboard: View {  // Renamed to SettingsViewDashboard
            ...
            VStack {
                ...
                Form {
                    ...
                    Section(header: Text("About Us")) {
                        VStack(alignment: .leading) {
                            Link("Visit Our Website", destination: URL(string: "https://github.com/aditya110603")!)
                                .font(.footnote)
